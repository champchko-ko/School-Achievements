...
import { Loader2, ChevronDown, Sparkles, GraduationCap, User, Users } from 'lucide-react';
      ...
      <div className={`flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10 transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className={`flex flex-col items-center gap-6 mb-12 transition-all duration-1000 delay-800 ${fadeIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-10 mt-4">
            {computerDeptTeacher && (
              <div className="text-center">
                <p className="text-blue-300 font-bold text-sm">معلمة الحاسوب</p>
                <p className="text-white font-bold">{computerDeptTeacher}</p>
              </div>
            )}
            {computerDeptHead && (
              <div className="text-center">
                <p className="text-blue-300 font-bold text-sm">رئيسة قسم الحاسوب</p>
