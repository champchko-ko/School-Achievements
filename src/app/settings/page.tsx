...
placeholder="مثال: 55xxxxxxx"
className="w-full bg-gray-50 border border-purple-100 rounded-xl p-3 focus:ring-2 focus:ring-[#46178f] outline-none transition-all"
/>
</div>

<div className="space-y-2">
<label className="text-sm font-bold text-gray-700 flex items-center gap-2"><User size={16}/> مدير المدرسة</label>
<input
type="text"
